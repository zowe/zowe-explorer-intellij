...
* Feature: GitHub issue #197: It is now possible to create Zowe Team config v2 template using "+" button ([6ee65922](https://github.com/zowe/zowe-explorer-intellij/commit/6ee65922))
...
* Feature: Zowe Team config v2 connection to the plug-in's native connection name is defined ([788e5021](https://github.com/zowe/zowe-explorer-intellij/commit/788e5021))
...
[2.4.0]: https://github.com/zowe/zowe-explorer-intellij/compare/2.3.0...2.4.0
[2.3.0]: https://github.com/zowe/zowe-explorer-intellij/compare/2.2.0...2.3.0
