...
class RenameOperationRunnerTestSpec : WithApplicationShouldSpec({
  ...
  context("RenameOperationRunner common spec") {
    ...
    context("canRun") {
      ...
      every { operation.attributes }.returnsMany(mockk<RemoteMemberAttributes>(), mockk<RemoteDatasetAttributes>(), mockk<RemoteUssAttributes>(), mockk<FileAttributes>())
    ...
    context("run operation") {
      ...
      should("run rename operation on RemoteDatasetAttributes given") {
        ...
        every { dataApi.renameDataset(any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } returns apiResponse
      ...
      should("throw RuntimeException while running rename operation on RemoteDatasetAttributes, if any error happened during processing the request") {
        // given
        every { dataApi.renameDataset(any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } answers {
      ...
      should("run rename operation on RemoteMemberAttributes given DuplicateMember requester") {
        ...
        every { dataApi.copyToDatasetMember(any(), any(), any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } returns apiResponse
      ...
      should("run rename operation on RemoteMemberAttributes given non DuplicateMember requester") {
        ...
        every { dataApi.renameDatasetMember(any(), any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } returns apiResponse
      ...
      should("throw RuntimeException while running rename operation on RemoteMemberAttributes, if response wan not successful for RenameAction requester") {
        ...
        every { dataApi.renameDatasetMember(any(), any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } answers {
          throw RuntimeException("TEST ERROR")
        }
      ...
      should("run rename operation on RemoteUssAttributes given") {
        ...
        every { dataApi.moveUssFile(any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } returns apiResponse
      ...
      should("throw RuntimeException while running rename operation on RemoteUssAttributes, if some error happened during request execution") {
        // given
        every { dataApi.moveUssFile(any(), any(), any(), any()).cancelByIndicator(progressIndicator).execute() } answers {
          throw RuntimeException("TEST ERROR")
        }
