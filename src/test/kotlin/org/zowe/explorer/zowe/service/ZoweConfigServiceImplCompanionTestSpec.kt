...
class ZoweConfigServiceImplCompanionTestSpec : AppInitShouldSpec("zowe/service/ZoweConfigServiceImpl.Companion", {
  context("all functions") {
    ...
    beforeEach {
      ...
      every {
        configServiceCrudable.getAll(any<Class<out ConnectionConfig>>())
      } answers {
