...
package org.zowe.explorer.explorer.actions.sort
...
abstract class SortAction<Node: ExplorerTreeNode<*, *>> : ToggleAction() {
  ...
  companion object {
    fun runRefreshAction(e: AnActionEvent) {
      val refreshActionInstance: AnAction = ActionManager.getInstance().getAction("org.zowe.explorer.explorer.actions.RefreshNodeAction")
