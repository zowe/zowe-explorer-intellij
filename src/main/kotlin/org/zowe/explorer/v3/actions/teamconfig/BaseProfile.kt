...
data class BaseProfile(
  val host: ProfileField<String?> = ProfileField(null, "Host", "host", "Host name of service on the mainframe"),
  val port: ProfileField<Int?> = ProfileField(null, "Port", "port", "Port number of service on the mainframe"),
  val user: ProfileField<String?> = ProfileField(null, "User", "user", "User name to authenticate to service on the mainframe"),
  val password: ProfileField<CharArray?> = ProfileField(null, "Password", "password", "Password to authenticate to service on the mainframe"),
  ...
  val tokenType: ProfileField<String?> = ProfileField(null, "Token type", "tokenType", "The type of token to get and use for the API. Omit this option to use the default token type, which is provided by 'zowe auth login'"),
  val tokenValue: ProfileField<String?> = ProfileField(null, "Token value", "tokenValue", "The value of the token to pass to the API"),
