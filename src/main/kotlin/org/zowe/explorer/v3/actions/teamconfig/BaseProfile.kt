...
data class BaseProfile(
  val host: ProfileField<String?> = ProfileField(null, "Host name of service on the mainframe"),
  val port: ProfileField<Int?> = ProfileField(null, "Port number of service on the mainframe"),
  val user: ProfileField<String?> = ProfileField(null, "User name to authenticate to service on the mainframe"),
  val password: ProfileField<CharArray?> = ProfileField(null, "Password to authenticate to service on the mainframe"),
  val rejectUnauthorized: ProfileField<Boolean?> = ProfileField(true, "Reject self-signed certificates"),
  val tokenType: ProfileField<String?> = ProfileField(null, "The type of token to get and use for the API. Omit this option to use the default token type, which is provided by 'zowe auth login'"),
  val tokenValue: ProfileField<String?> = ProfileField(null, "The value of the token to pass to the API"),
