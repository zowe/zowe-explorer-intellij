...
import org.zowe.explorer.v3.newoperations.RefreshNodesOperationResult
import org.zowe.explorer.v3.tree.nodes.NodeSyncService

// TODO: doc
class RefreshJobFilterNodesOperation(
  override val operationData: RefreshJobFilterNodesOperationData
  ...
  override fun run(): RefreshNodesOperationResult {
    ...
    return RefreshJobFilterNodesOperationResult()
  }
}
