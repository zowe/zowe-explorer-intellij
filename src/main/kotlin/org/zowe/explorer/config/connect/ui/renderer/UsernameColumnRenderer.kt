 ...
 */
class UsernameColumnRenderer(private val isZoweConfig: Boolean) : IconTableCellRenderer<String>() {
  ...
  override fun getTableCellRendererComponent(
    ...
    val valueToDisplay = if (isZoweConfig) "*".repeat(8) else value
    super.getTableCellRendererComponent(table, valueToDisplay, selected, focus, row, column)
