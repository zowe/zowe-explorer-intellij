...
class ForceRenameAction : AnAction() {
    ...
    private fun runRenameOperation(project : Project?, file : MFVirtualFile, attributes: FileAttributes, newName: String, node: ExplorerTreeNode<*>, override : Boolean) {
    ...
    override fun update(e: AnActionEvent) {
        ...
        e.presentation.isEnabledAndVisible = selectedNodes.size == 1 && ((node is UssDirNode && !node.isConfigUssPath) || node is UssFileNode)
