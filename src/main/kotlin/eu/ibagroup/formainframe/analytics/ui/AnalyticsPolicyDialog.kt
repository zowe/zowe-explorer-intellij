...
class AnalyticsPolicyDialog(
  ...
  companion object {
    /**
     * Build license component with the provided parameters
     * @param policyText the policy text for user to read
     * @param agreementText the agreement text on button
     * @param numberOfColumns the number of text area
     * @param fontSize the font size for the agreement
     */
