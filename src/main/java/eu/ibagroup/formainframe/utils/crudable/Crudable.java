...
public interface Crudable {
  ...
  /**
   * Replace the rows by the class with the new provided rows
   *
  ...
  /**
   * Get field that match the specified column value
   *
   * @param rowClass    row class to get rows by
   * @param columnName  column name to get fields by
   * @param columnValue column value to find field by
   */
  @SuppressWarnings("unchecked")
  ...
  /**
   * Get unique value for the provided row
   *
   * @param row the row to search for the unique value
   */
