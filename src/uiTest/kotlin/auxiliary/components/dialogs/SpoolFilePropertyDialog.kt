...
class SpoolFilePropertyDialog(fixtureStack: MutableList<Locator>, remoteRobot: RemoteRobot) :AbstractDialog(fixtureStack, remoteRobot)  {
...
//     * On Data tab
//     */
//    fun checkDataTabParams(propertyMap: Map<String,String>): Boolean  = with(remoteRobot) {
//        val jobGeneralParams = findAll<JTextFieldFixture>(datasetNameInputLoc)
//        dataTabParams.withIndex().forEach { (index, element) ->
...
//     * On General tab
//     */
//    fun checkGeneralTabParams(propertyMap: Map<String,String>): Boolean  = with(remoteRobot) {
//        val jobGeneralParams = findAll<JTextFieldFixture>(datasetNameInputLoc)
//        generalTabParams.withIndex().forEach { (index, element) ->
//            if(propertyMap.getValue(element) != jobGeneralParams[index].text) {
//                return false
//            }
//        }
